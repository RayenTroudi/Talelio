        ...
        <div className="relative bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white pt-32 pb-28 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-16 text-center">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-light mb-8 tracking-tight">
              <span className="font-serif italic text-gold-400">{t.contact.title}</span>
            </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-7">
                ...
                <div className="text-right">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-6 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-gold-500 focus:border-transparent transition-all text-left placeholder:text-gray-400 placeholder:font-light bg-white shadow-sm"
                ...
                <div className="text-right">
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-6 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-gold-500 focus:border-transparent transition-all resize-none text-right placeholder:text-gray-400 placeholder:font-light bg-white shadow-sm"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white font-light py-5 px-8 rounded-2xl transition-all duration-500 transform hover:scale-[1.02] shadow-xl hover:shadow-2xl tracking-wide text-base"
                >
                  {t.contact.sendBtn}
                </button>
              </form>
              ...
              <div className="space-y-10">
                <div className="group">
                  <div className="flex items-center gap-5 mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-gold-100 to-gold-200/50 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                  ...
                  <div className="pr-20">
                    <a href="mailto:contact@perfumebrand.com" className="text-gray-600 hover:text-gold-600 transition-colors duration-300 font-light text-lg block" dir="ltr">
                ...
                <div className="group">
                  ...
                  <div className="pr-20">
                    <a href="tel:+1234567890" className="text-gray-600 hover:text-gold-600 transition-colors duration-300 font-light text-lg block" dir="ltr">
                      +1 (234) 567-890
                    </a>
                  </div>
                </div>
