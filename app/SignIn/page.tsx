  ...
  return (
    <div className='min-h-screen bg-white flex items-center justify-center py-12 px-4'>
        <div className='w-full max-w-md'>
                ...
                <h1 className='text-4xl font-light mb-12 text-center text-gray-900 tracking-tight'>تسجيل الدخول</h1>
                ...
                <form className='flex flex-col gap-6' onSubmit={HandleSubmit}>
                    ...
                    <Link href='/Register' className='text-sm mt-4 text-center text-gray-600 hover:text-gray-900 font-light transition-colors'>
                      ليس لديك حساب؟ <span className='underline text-amber-600 hover:text-amber-700'>سجل الآن</span>
                    </Link>
                </form>
        </div>  
    </div>
