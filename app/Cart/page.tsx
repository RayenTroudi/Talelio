          ...
          {isClient ? (
            hideloading ? (
              ...
              <>
                  ...
                  <div className="overflow-x-auto md:col-span-3">
                    ...
                    <div className="bg-white rounded-3xl border border-gold-200/50 shadow-xl overflow-hidden">
                      <table className="min-w-full">
                        <thead className="bg-gradient-to-r from-gold-50/50 via-white to-gold-50/30 border-b border-gold-200/50">
                          <tr>
                        ...
                        <tbody>
                          {CartItems.map((item: any) => (
                            <tr key={`${item.id}-${item.size || 'default'}`} className="border-b border-stone-100 hover:bg-gradient-to-r hover:from-gold-50/30 hover:to-transparent transition-all duration-300">
                              <td className="p-6">
                              ...
                              <td className="p-6 text-right">
                                <span className="text-gold-600 font-light text-lg">{itemsPrice} TND</span>
                              </td>
                              <td className="p-6 text-center">
                                <button
                                  className="px-6 py-2.5 text-sm font-light text-stone-600 hover:text-gold-600 border border-stone-200 hover:border-gold-600 rounded-xl transition-all duration-300"
                ...
                <div className="mt-8 p-8 bg-gradient-to-br from-gold-50/50 via-white to-gold-50/30 rounded-3xl border border-gold-200/50 shadow-xl">
                  {/***********SubTotal Items**********************/}
                  <div className="text-right text-stone-900 font-light text-xl mb-6">
                    ...
                    <span className="text-gold-600 font-normal text-2xl">{itemsPrice} TND</span>
                  </div>

                  {/************ Go To Shipping Page**********************/}
                  <div className="flex justify-center mt-8">
                    <button
                      className="w-full max-w-md bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white px-12 py-5 cursor-pointer rounded-2xl font-light text-lg tracking-wide shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
